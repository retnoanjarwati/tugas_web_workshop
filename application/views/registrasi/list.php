...
<div class="bgwhite">
	...
	<p class="alert alert-success">Sudah memiliki akun? Silahkan <a href="<?php echo base_url('masuk') ?>" class="btn btn-info btn-sm">Login di disini</a></p>
	...
	<div class="col-md-12">
		...
		<table class="table">
			<thead>
				<tr>
					<th>Nama</th>
					<th><input type="text" name="nama_distributor" class="form-control" placeholder="Nama Lengkap" value="<?php echo set_value('nama_distributor') ?>" required></th>
				</tr>
			</thead>
			<tbody>
				<tr>
				...
				<tr>
					<td>Telephon</td>
					<td><input type="text" name="telephon" class="form-control" placeholder="Telephon" value="<?php echo set_value('telephon') ?>" required></td>
				</tr>
				<tr>
					<td>Alamat</td>
