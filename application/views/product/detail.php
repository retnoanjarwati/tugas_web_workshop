		...
		<div class="container">
			...
			<div class="wrap-slick2">
				...
				<div class="item-slick2 p-l-15 p-r-15">
					...
					echo form_open(base_url('belanja/add')); 
					//elemen yang dibawa
					echo form_hidden('id', $product_related->id_product);
					echo form_hidden('qty', 1);
					echo form_hidden('price', $product_related->harga);
					echo form_hidden('name', $product_related->nama_product);
					//elemen redirect
					echo form_hidden('redirect_page', str_replace('index.php/', '', current_url()));
					?>
					<!-- Block2 -->
					<div class="block2">
						...
						<div class="block2-txt p-t-20">
							<a href="<?php echo base_url('product/detail/'.$product->slug_product) ?>" class="block2-name dis-block s-text3 p-b-5">
								<?php echo $product_related->nama_product ?>
							</a>

							<span class="block2-price m-text6 p-r-5">
								IDR <?php echo number_format($product_related->harga,'0',',','.') ?>
							</span>
						</div>
					</div>
					<?php echo form_close(); ?>
