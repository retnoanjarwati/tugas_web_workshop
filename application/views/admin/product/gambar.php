...
// Form open
echo form_open_multipart(base_url('admin/product/gambar/'.$product->id_product), ' class="form-horizontal"');
 ?>
 ...
 <div class="form-group form-group-lg">
  ...
  <div class="col-md-8">
    <input type="text" name="judul_gambar" class="form-control" placeholder="Judul Gambar Product" value="<?php echo set_value('judul_gambar') ?>" required>
  </div>
</div>
 	...
 	<tbody>
 		...
 		<tr>
 			...
 			<td>
 				...
 				<a href="<?php echo base_url('admin/product/delete_gambar/'.$product->id_product.'/'.$gambar->id_gambar) ?>" class="btn btn-danger btn-xs" onclick="return confirm('Yakin ingin menghapus gambar ini?')" ><i class="fa fa-trash-o"></i> Hapus</a>
 			</td>
 		</tr>
 	<?php } ?>
 	</tbody>
