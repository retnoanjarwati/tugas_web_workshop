...
// Form open
echo form_open_multipart(base_url('admin/product/tambah'), ' class="form-horizontal"');
 ?>
 ...
 <div class="form-group">
  ...
  <div class="col-md-5">
    <input type="text" name="nama_product" class="form-control" placeholder="Nama Product" value="<?php echo set_value('nama_product') ?>" required>
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-5">
    <input type="text" name="kode_product" class="form-control" placeholder="Kode Product" value="<?php echo set_value('kode_product') ?>" required>
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-5">
    <input type="number" name="harga" class="form-control" placeholder="Harga Product" value="<?php echo set_value('harga') ?>" required>
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-5">
    <input type="number" name="stok" class="form-control" placeholder="Stok Product" value="<?php echo set_value('stok') ?>" required>
  </div>
</div>
